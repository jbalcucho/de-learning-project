...
if __name__ == "__main__":
    ...
    if movies_raw:
        ...
        save_to_json(
            transformed_movies, os.path.join(PROCESSED_DIR, "movies_cleaned.json")
        )

        # 2. Save the set of unique genres
        save_to_txt(unique_genres, os.path.join(PROCESSED_DIR, "unique_genres.txt"))
        ...
        save_to_csv(
            movies_for_csv,
            "data/processed/movie_id_title_year.csv",
